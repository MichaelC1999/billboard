...
export function InstallSnap({ displayManualInstall }: any) {
    ...
    if (displayManualInstall) {
        button = <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
            <Button variant="contained" color="primary" disabled={window.ethereum.networkVersion + "" !== process.env.NEXT_PUBLIC_CHAIN_ID + "" || !isFlaskBool} onClick={installBillboardSnap} className={classes.button}>
